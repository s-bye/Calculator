...
def button_click(value):
    if value == "C":
        ...
        display_label.config(text=calculator.expression)
    else:
        calculator.add_to_expression(value)
        display_label.config(text=calculator.expression)
...
display_label = Label(window, text="", font=oswald_font, bg="#212020", fg="#745FF2", anchor="e")
